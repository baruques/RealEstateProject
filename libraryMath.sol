...
// Bibliotecas (Librarys) são semelhantes a contratos, mas você não pode declarar nenhuma variável de estado e não
// pode enviar ether.
...
contract TestLibrary {
    ...
    //devemos declarar que vamos usar a Library Math caso queira usar sem chamar ela em especifico como na primeira
    // funcao
